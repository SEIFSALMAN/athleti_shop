...
class SuccessAnimationScreen extends StatelessWidget {
  const SuccessAnimationScreen({super.key, required this.image, required this.title, required this.subTitle, required this.onPressed});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Padding(
          padding: TSpacingStyle.paddingWithAppBarHeightAndNoBottom * 2,
          child: Column(
            children: [
              /// Image
